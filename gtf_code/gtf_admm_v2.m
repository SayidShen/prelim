function [ x, history] = gtf_admm_v2( y,D,k,lambda, rho, varargin )
addpath('TVexact')
%GTF_ADMM_V2 Summary of this function goes here
...
while ~conv
   ...
   if ~CHOLESKY
   [x,pcg_flg]=pcg(A,(Lk*(rho*z-u)+y),tol_pcg,k*100,spdiags(diag(A),0,size(A,1),size(A,2)));
    if pcg_flg~=0
